  ...
  data: function () {
    return {
      education: [
        ...
        {
          id: 2,
          institute: "Shaheed Ramiz Uddin Cantonment College",
          major: "HSC",
          subject: "Science",
          start: 2012,
          end: 2014,
          outline:
            "Shaheed Bir Bikrom Ramiz Uddin Cantonment College is a school and college in Dhaka, Bangladesh. It is managed by the Bangladesh Army.",
        },
        {
          id: 3,
          ...
          outline:
            "Khilbarirtek Islamia High School is one of the popular High School located in Badda, Dhaka.",
        },
      ],
    };
  },
